...
import { StyledCheckboxItem, StyledContent, StyledItem, StyledLabel, StyledRadioItem, StyledSeparator, StyledShortcut, StyledSubContent, StyledSubTrigger } from "./index.style"
...
>(({ className, w, sideOffset = 4, ...props }, ref) => (
